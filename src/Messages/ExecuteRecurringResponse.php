...
class ExecuteRecurringResponse extends AbstractResponse implements RedirectResponseInterface
{
    ...
    public function getMessage()
    {
        ...
        switch ($code) {
            ...
            case 106:
                return 'Decline, allowable PIN tries exceeded';
            case 107:
                return 'Decline, refer to card issuer';
            case 108:
                return 'Decline, refer to card issuer\'s special conditions, merchant shall contact cardholder';
            case 109:
            ...
            case 112:
                return 'Decline, PIN data required';
            case 113:
            ...
            case 126:
                return 'Decline, invalid PIN block';
            case 127:
                return 'Decline, PIN length error';
            case 128:
                return 'Decline, PIN kay synch error';
            case 129:
                return 'Decline, suspected counterfeit card';
            case 180:
                return 'Cardholder has requested blocking of recurring payment or regular payment has been deleted';
            case 197:
                return 'Decline, call AmEx';
            case 198:
                return 'Decline, call Card Processing Centre';
        }
